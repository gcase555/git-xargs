...
1. **Export a valid GitHub token**. See the guide on [Github personal access
   ...
   for information on how to generate one. For example, on Linux or Mac, you'd run:
      ...
      ```bash
      export GIX_XARGS_AUTH_TOKEN=<your-secret-github-oauth-token>
      ```
...
| `--github-org`                        | If you want to target every repo in a Github org that your GIX_XARGS_AUTH_TOKEN has access to, pass the name of the Organization with this flag, to page through every repo via the Github API and target it.                                                                                                                                                                                                                                     | String  | No       |
